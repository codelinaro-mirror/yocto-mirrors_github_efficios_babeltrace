...
def _run_exit_status_test(build_root_dir, case):
...
class TestInterruptedGraph:
    ...
    def cli_run(self, build_root_dir):
        return _run_exit_status_test(build_root_dir, "INTERRUPTED")
...
class TestErrorGraph:
    @pytest.fixture(scope="class")
    def cli_run(self, build_root_dir):
        return _run_exit_status_test(build_root_dir, "ERROR")
...
class TestStopGraph:
    @pytest.fixture(scope="class")
    def cli_run(self, build_root_dir):
        return _run_exit_status_test(build_root_dir, "STOP")
